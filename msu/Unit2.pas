...
//       adoquery1.Free;
   ...
   begin
      showmessage('Такой студент не существует! Обращайтесь к администратору!');
   end;
...
begin
      ...
      if R2<>0 then
      begin
        ShowMessage('Вы уже зарегистрированы!');
        Form2.Close;
      end
      else
      begin
      ...
      begin
        ...
        if R3=0 then
        begin
          showmessage('Вы не можете зарегистрироваться! Обращайтесь к администратору!');
          Form2.Close;
        end;
         if (R1>0) then
        begin
