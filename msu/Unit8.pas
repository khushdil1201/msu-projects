...
begin
 ...
 with Form5 do
   begin
      ...
      with adoquery1 do
      begin
          if FieldByName('TSubject').AsString='Лекция' then
           Memo1.Color:=clRed;
          if FieldByName('TSubject').AsString='Практика' then
           Memo1.Color:=clLime;
          if FieldByName('TSubject').AsString='Поток' then
           Memo1.Color:=clYellow;
          if FieldByName('TSubject').AsString='Кураторский час' then
...
//   begin
//     Combobox3.Items.Add('Прикладная математика и информатика');
//     Combobox3.Items.Add('Геология');
//     Combobox3.Items.Add('Химия,физика и механика материалов');
//   end;
//   if combobox4.ItemIndex=1 then
//   begin
//     Combobox3.Items.Add('Международные отношения');
//     Combobox3.Items.Add('Государственное и муниципальное управление');
//     Combobox3.Items.Add('Лингвистика');
//   end;
end;
...
//   Label4.Enabled:=True;
   ...
   if combobox4.ItemIndex=0 then
   begin
     Form8.Combobox3.Items.Add('Прикладная математика и информатика');
     Form8.Combobox3.Items.Add('Геология');
     Form8.Combobox3.Items.Add('Химия,физика и механика материалов');
   end;
   if combobox4.ItemIndex=1 then
   begin
     Form8.Combobox3.Items.Add('Международные отношения');
     Form8.Combobox3.Items.Add('Государственное и муниципальное управление');
     Form8.Combobox3.Items.Add('Лингвистика');
   end;
